...
Еще фильмы можно импортировать из файла. Для этого нужно выбрать файл который находится на вашем компьютере и нажать на кнопку «submit».  Расширения файла должно быть (.txt) и размер не должен превышать 500 кб.
Информация о фильмах должна быть в следующем формате:
...
Если все правила соблюдены — все фильмы должны добавится в хранилище и появится в общем списке. Еще появится информация о успешном добавлении.
